...
def init(port):
    ...
    print("Serial port "+ com.port +' Opened' if com.is_open else ' Close')
...
def run(data):
    dataLux = live_debug(data)
    # print('Python data: ',dataLux)
    return dataLux
